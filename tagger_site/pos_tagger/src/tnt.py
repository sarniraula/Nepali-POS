...
DICTIONARY_DIR = '/home/sandesh/Major/site/tagger_site/pos_tagger/src/dictionary'
TEST_DIR = 'test'
...
class TntTagger:
    ...
    def __init__(self):
            ...
            if os.path.isdir(DICTIONARY_DIR):
                ...
                for rootdir, dirs, files in os.walk(NEPALI_CORPUS_DIR):
                    count1=0
                    for name in files:
    ...
    def tag(self, sentence):
        tags = self.get_tag_sequence(sentence)
        word_tag_list = list()
        for i in range(0, len(tags)):
            word_tag_list.append((sentence[i], tags[i + 1]))
